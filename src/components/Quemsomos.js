...
export default function Quem_somos() {
    return (
        <div className={Styles.quemsomos}>
            ...
            <p className={Styles.text1}>Certa Corretoras de Seguros Ltda, é uma corretora consolidada no mercado segurador, contando com uma equipe especializada em excelência em atendimento a clientes.</p>
